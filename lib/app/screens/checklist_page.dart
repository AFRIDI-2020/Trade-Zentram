                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  ElevatedButton(
                                    onPressed: () {
                                      Get.off(() => DownActivityTaskPage(pageTitle: pageTitle,),
                                    ...
                                    builder: (BuildContext context) {
                                      ...
                                      return AlertDialog(
                                        ...
                                        content: Column(
                                          mainAxisSize: MainAxisSize.min,
                                          children: [
                                            Image.asset("assets/ic_return_product.png", height: 80, width: 80,),
                                            const SizedBox(
                                              height: 4,
                                            ),
                                            Text("Return Product", style: theme.textTheme.titleLarge),
                                            const SizedBox(
                                              height: 16,
                                            ),
                                           Text(
                      ...
                      child: ListTile(
                        ...
                        trailing: Container(
                          ...
                          child: DropdownButton<StatusLsit>(
                            ...
                            // Initial value
                            onChanged: (StatusLsit? newValue) async {
                              if (!await AuthController().handleLocationPermission()) {
                                AuthController().logout();
                              } else {
                                if (context.mounted) {
